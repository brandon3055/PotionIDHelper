...
public class ClassTransformer implements IClassTransformer {
	...
	private byte[] patchPotionClass(byte[] basicClass) {
		...
		if (setPotionName != null)
		{
			...
			toInsert.add(new MethodInsnNode(INVOKESTATIC, "com/brandon3055/potionidhelper/asm/MethodHolder", "addPotionForSorting", "(Lnet/minecraft/potion/Potion;Ljava/lang/String;)V", false));
	...
	private byte[] patchPotionEffect(byte[] basicClass) {
		...
		if (readCustomPotionEffectFromNBT != null)
		{
			...
			toInsert.add(new VarInsnNode(ALOAD, 0));
			toInsert.add(new MethodInsnNode(INVOKESTATIC, "com/brandon3055/potionidhelper/asm/MethodHolder", "readCustomPotionEffectFromNBT", "(Lnet/minecraft/nbt/NBTTagCompound;)Lnet/minecraft/potion/PotionEffect;", false));
		...
		if (writeCustomPotionEffectToNBT != null)
		{
			...
			toInsert.add(new VarInsnNode(ALOAD, 0));
			toInsert.add(new VarInsnNode(ALOAD, 1));
			toInsert.add(new MethodInsnNode(INVOKESTATIC, "com/brandon3055/potionidhelper/asm/MethodHolder", "writeCustomPotionEffectToNBT", "(Lnet/minecraft/potion/PotionEffect;Lnet/minecraft/nbt/NBTTagCompound;)Lnet/minecraft/nbt/NBTTagCompound;", false));
			toInsert.add(new InsnNode(ARETURN));
